...
class SEBIScraper(IScraper):
    ...
    def _fetch_listing_page(self, from_date: date, to_date: date, page_index: int, dept_id: int = -1) -> str:
        ...
        return self._fetch_with_retry(
            ...
            max_retries=self.listing_max_retries,
            backoff_seconds=self.listing_retry_backoff_seconds,
            timeout=self.listing_timeout_seconds,
            extra_log={"from_date": str(from_date), "to_date": str(to_date), "page_index": page_index, "dept_id": dept_id},
            data=payload,
    ...
    def _fetch_detail_page(self, detail_url: str) -> str:
        ...
        return self._fetch_with_retry(
            ...
            backoff_seconds=self.detail_retry_backoff_seconds,
            timeout=self.detail_timeout_seconds,
            extra_log={"detail_url": detail_url},
